...
test_that("lmom_theoretical_glo matches results from 'lmom' package", {
	test_lmom("GLO", c(1600, 616, 0.12), c(1476.3597, 630.8368, -0.12, 0.1787))
	test_lmom("GLO", c(29, 15, -0.09), c(31.2415, 15.2017, 0.09, 0.1734))
})

test_that("lmom_theoretical_gno matches results from 'lmom' package", {
...
test_that("lmom_theoretical_pe3 matches results from 'lmom' package", {
...
test_that("lmom_theoretical_wei matches results from 'lmom' package", {
