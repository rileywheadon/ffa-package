...
test_that("Test s-bootstrap.R on data set #1 with L-moments", {
	...
	GEV <- uncertainty_bootstrap(df$max, "GEV", "L-moments")
	...
	GUM <- uncertainty_bootstrap(df$max, "GUM", "L-moments")
	...
	NOR <- uncertainty_bootstrap(df$max, "NOR", "L-moments")
	...
	LNO <- uncertainty_bootstrap(df$max, "LNO", "L-moments")
	...
	GLO <- uncertainty_bootstrap(df$max, "GLO", "L-moments")
	...
	PE3 <- uncertainty_bootstrap(df$max, "PE3", "L-moments")
	...
	GNO <- uncertainty_bootstrap(df$max, "GNO", "L-moments")
	...
	WEI <- uncertainty_bootstrap(df$max, "WEI", "L-moments")
...
test_that("Test s-bootstrap.R on data set #2 with L-moments", {
	...
	LP3 <- uncertainty_bootstrap(df$max, "LP3", "L-moments")
...
test_that("Test s-bootstrap.R on data set #3.1 with MLE", {
	...
	# Generalized Extreme Value (GEV) Distribution
	GEV <- uncertainty_bootstrap(df$max, "GEV", "MLE", samples = 1000L)
	...
	# Gumbel (GUM) Distribution
	GUM <- uncertainty_bootstrap(df$max, "GUM", "MLE", samples = 1000L)
	...
	# Normal (NOR) Distribution
	NOR <- uncertainty_bootstrap(df$max, "NOR", "MLE", samples = 1000L)
	...
	# Log-Normal (LNO) Distribution
	LNO <- uncertainty_bootstrap(df$max, "LNO", "MLE", samples = 1000L)
	...
	# Log-Pearson Type III (LP3) Distribution
	LP3 <- uncertainty_bootstrap(df$max, "LP3", "MLE", samples = 1000L)
	...
	# Generalized Normal (GNO) Distribution
	GNO <- uncertainty_bootstrap(df$max, "GNO", "MLE", samples = 1000L)
