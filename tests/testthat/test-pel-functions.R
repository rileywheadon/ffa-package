test_that("pelxxx functions work on data set #1", {
...
test_that("pelxxx functions work on data set #2", {
...
test_that("pelxxx functions work on data set #3.1", {
...
test_that("pelxxx functions work on data set #3.2", {
...
test_that("pelxxx functions work on data set #3.3", {
