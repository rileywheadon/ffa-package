...
test_that("Test gmle-estimation.R on data set #1", {
	...
	validate(df, gllgev100, c(1487.6338, 230.3059, 646.2991, 0.1135),-709.2092)
	validate(df, gllgev110, c(1505.3244, 194.4710, 673.0143, -57.3739, 0.1138),-709.0962)
...
test_that("Test gmle-estimation.R on data set #2", {
	...
	validate(df, gllgev100, c(1871.0704, -1001.6282, 498.7795, 0.1111),-606.0335)
	validate(df, gllgev110, c(1570.3348, -289.4988, 398.6958, 358.7930, 0.1137),-616.6930)
...
test_that("Test gmle-estimation.R on data set #3.1", {
	...
	validate(df, gllgev100, c(201.0305, -37.4812, 45.5528, 0.1129),-467.7028)
	validate(df, gllgev110, c(204.3781, -44.1795, 50.7347, -10.9589, 0.1132),-467.3164)
...
test_that("Test gmle-estimation.R on data set #3.2", {
	...
	validate(df, gllgev100, c(56.8414, 10.1595, 16.2665, 0.1131),-290.5041)
	validate(df, gllgev110, c(59.9994, 4.2448, 17.9675, -3.0089, 0.1136),-291.4294 )
...
test_that("Test gmle-estimation.R on data set #3.3", {
	...
	validate(df, gllgev100, c(21.1740, 16.9244, 14.6350, 0.1096),-301.7242)
	validate(df, gllgev110, c(22.6165, 5.2098, 6.8001, 16.8263, 0.1100),-301.6069)
