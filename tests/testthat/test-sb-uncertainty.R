...
test_that("Test s-bootstrap.R on data set #1 with L-moments", {
	...
	GEV <- sb.uncertainty(df$max, df$year, "GEV", NULL, "L-moments")[[1]]
	...
	GUM <- sb.uncertainty(df$max, df$year, "GUM", NULL, "L-moments")[[1]]
	...
	NOR <- sb.uncertainty(df$max, df$year, "NOR", NULL, "L-moments")[[1]]
	...
	LNO <- sb.uncertainty(df$max, df$year, "LNO", NULL, "L-moments")[[1]]
	...
	GLO <- sb.uncertainty(df$max, df$year, "GLO", NULL, "L-moments")[[1]]
	...
	PE3 <- sb.uncertainty(df$max, df$year, "PE3", NULL, "L-moments")[[1]]
	...
	GNO <- sb.uncertainty(df$max, df$year, "GNO", NULL, "L-moments")[[1]]
	...
	WEI <- sb.uncertainty(df$max, df$year, "WEI", NULL, "L-moments")[[1]]
...
test_that("Test s-bootstrap.R on data set #2 with L-moments", {
	...
	LP3 <- sb.uncertainty(df$max, df$year, "LP3", NULL, "L-moments")[[1]]
...
test_that("Test s-bootstrap.R on data set #3.1 with MLE", {
	...
	# Generalized Extreme Value (GEV) Distribution
	GEV <- sb.uncertainty(df$max, df$year, "GEV", NULL, "MLE", n_sim = 1000)[[1]]
	...
	# Gumbel (GUM) Distribution
	GUM <- sb.uncertainty(df$max, df$year, "GUM", NULL, "MLE", n_sim = 1000)[[1]]
	...
	# Normal (NOR) Distribution
	NOR <- sb.uncertainty(df$max, df$year, "NOR", NULL, "MLE", n_sim = 1000)[[1]]
	...
	# Log-Normal (LNO) Distribution
	LNO <- sb.uncertainty(df$max, df$year, "LNO", NULL, "MLE", n_sim = 1000)[[1]]
	...
	# Log-Pearson Type III (LP3) Distribution
	LP3 <- sb.uncertainty(df$max, df$year, "LP3", NULL, "MLE", n_sim = 1000)[[1]]
	...
	# Generalized Normal (GNO) Distribution
	GNO <- sb.uncertainty(df$max, df$year, "GNO", NULL, "MLE", n_sim = 1000)[[1]]
