test_that("Test l-kurtosis.R on data set #1", {
	...
	# Check the distances
	expect_equal(results$metrics$GEV, 0.0103, tol = 1e-4) 
	expect_equal(results$metrics$GUM, 0.0466, tol = 1e-4) 
	expect_equal(results$metrics$NOR, 0.0744, tol = 1e-4) 
	expect_equal(results$metrics$LNO, 0.0472, tol = 1e-4) 
	expect_equal(results$metrics$GLO, 0.0215, tol = 1e-4) 
	expect_equal(results$metrics$PE3, 0.0525, tol = 1e-4) 
...
test_that("Test l-kurtosis.R on data set #2", {
	...
	# Check the distances
	expect_equal(results$metrics$GEV, 0.0887, tol = 1e-4) 
	expect_equal(results$metrics$GUM, 0.1076, tol = 1e-4) 
	expect_equal(results$metrics$NOR, 0.0798, tol = 1e-4) 
	expect_equal(results$metrics$LNO, 0.0775, tol = 1e-4) 
	expect_equal(results$metrics$GLO, 0.1350, tol = 1e-4) 
	expect_equal(results$metrics$PE3, 0.0839, tol = 1e-4) 
...
test_that("Test l-kurtosis.R on data set #3.1", {
	...
	# Check the distances
	expect_equal(results$metrics$GEV, 0.0245, tol = 1e-4) 
	expect_equal(results$metrics$GUM, 0.0275, tol = 1e-4) 
	expect_equal(results$metrics$NOR, 0.0003, tol = 1e-4) 
	expect_equal(results$metrics$LNO, 0.0244, tol = 1e-4) 
	expect_equal(results$metrics$GLO, 0.0657, tol = 1e-4) 
	expect_equal(results$metrics$PE3, 0.0081, tol = 1e-4) 
...
test_that("Test l-kurtosis.R on data set #3.2", {
	...
	# Check the distances
	expect_equal(results$metrics$GEV, 0.0058, tol = 1e-4) 
	expect_equal(results$metrics$GUM, 0.0004, tol = 1e-4) 
	expect_equal(results$metrics$NOR, 0.0274, tol = 1e-4) 
	expect_equal(results$metrics$LNO, 0.0032, tol = 1e-4) 
	expect_equal(results$metrics$GLO, 0.0447, tol = 1e-4) 
	expect_equal(results$metrics$PE3, 0.0165, tol = 1e-4) 
...
test_that("Test l-kurtosis.R on data set #3.3", {
	...
	# Check the distances
	expect_equal(results$metrics$GEV, 0.1070, tol = 1e-4) 
	expect_equal(results$metrics$GUM, 0.1262, tol = 1e-4) 
	expect_equal(results$metrics$NOR, 0.0984, tol = 1e-4) 
	expect_equal(results$metrics$LNO, 0.0669, tol = 1e-4) 
	expect_equal(results$metrics$GLO, 0.1535, tol = 1e-4) 
	expect_equal(results$metrics$PE3, 0.1025, tol = 1e-4) 
