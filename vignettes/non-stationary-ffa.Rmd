...
To specify a trend in the time series during FFA, create a `structure` list as shown below:
...
Since the dataset has a nonstationary structure, three additional arguments are required:
