...
From the `recommendations` item, we can see that the FFA framework recommends a split point in 1974.
...
- `recommendations`: The recommended approach, split points, and model structures from EDA.
