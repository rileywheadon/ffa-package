...
#'
#' @param results List; runs test results generated by \link{eda_sens_trend}.
#'
...
#' sens.plot(data, years, results, "mean")
#'
#' @import ggplot2
#' @importFrom grid textGrob
#' @export

sens.plot <- function(data, years, results, type, show_trend = TRUE) {
