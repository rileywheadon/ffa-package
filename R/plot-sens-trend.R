...
#'
#' @description
#' Produces a scatter plot of the annual maximum series (AMS) data or its variance
...
#'
#' @param mean_trend A list of Sen's trend estimates generated by \link{eda_sens_trend}.
#'
#' @param variability_trend Trend in variability generated by \link{eda_sens_trend}.
#'
