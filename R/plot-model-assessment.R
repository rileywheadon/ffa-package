...
#'
#' @param results List; model assessment results generated by \link{model.assessment}.
#'
...
#' results <- model.assessment(data, years, "NOR", params, uncertainty)
#'
#' # Generate a model assessment plot
#' assessment.plot(data, results)
#'
#' @import ggplot2
#' @export

assessment.plot <- function(data, results) {
