# Computes the L-moments of a probability distribution given its parameters.
#
# Takes a distribution (stationary only) and a vector of parameters (must have correct length)
#
