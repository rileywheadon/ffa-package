...
#'
#' @param results List; model assessment results generated by [model_diagnostics()].
#'
#' @param ... Optional named arguments: 'title', 'xlabel', and 'ylabel'.
#'
#' @return \code{ggplot}; a plot containing:
#' - A black line representing a model with no deviation from the emprical quantiles.
